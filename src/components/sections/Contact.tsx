        ...
        <div className="flex lg:flex-row flex-col gap-4">
          <div className="textbox bg-slate-100 w-full flex flex-col  ">
            <div className="px-8 md:px-10 pt-8 md:pt-10">
              <p
                className={`${styles.contactTextMain} tracking-wide text-surella-700 leading-relaxed text-justify`}
              >
                {text}
              </p>
            </div>
            <div className="md:h-1/2 my-8 md:my-16 bg-red-30 flex flex-col gap-6 items-center">
              <div className=" flex justify-center items-center">
                <div className="flex items-center ">
                  <BsFillTelephoneFill
                    className="flex text-surella-600 h-8 w-8 md:h-10 md:w-10 mr-2 md:mr-10"
                    style={{ marginLeft: "0px" }}
                  />
                  <div className="flex flex-col gap-2 h-fit text-center justify-center items-center">
                    <p
                      className={`${styles.contactText} text-surella-600 font-[700] tracking-wider`}
                    >
                      +48 510 122 295
                    </p>
                    <p
              ...
              <div className="w-80  h-[1px]  bg-surella-600"></div>
              <div className="h-fit text-center flex justify-center items-center">
                ...
                <p
                  className={`${styles.contactText} flex justify-center text-nowrap text-surella-600 font-[700] tracking-wider`}
                >
                  biuro@surella.pl
                </p>
              </div>
          ...
          <div className="conbox w-full h-full bg-surella-600">
            <form
              ...
              className="w-full h-full flex flex-col uppercase tracking-wide text-white p-8 md:p-10"
            >
              ...
              <div className="w-full h-full flex flex-col">
                ...
                <p className={`${styles.contactForm} pt-2 pb-1`}>
                  Numer telefonu
                </p>
                <input
                  name="telephone"
                ...
                <div className="flex justify-between items-center mt-10 gap-4">
                  ...
                  {status && (
                    <p className="text-center text-xs md:text-base">{status}</p>
                  )}
                </div>
              </div>
            </form>
