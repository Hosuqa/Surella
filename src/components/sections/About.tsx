...
const IconBox = ({title, icon}: Props) => {
  return (
    <div
    className='bg-surella-600 text-white w-full h-full min-w-[160px] flex flex-col justify-center items-center p-6'>
    ...
    <XlWrapper id='About' vertical >
      <div  className="bg-white w-full flex-col">
        ...
        <div className='flex xl:flex-row flex-col w-full gap-4'>
          <motion.div
          variants={fadeIn("",0.4,0.5)}  initial="hidden"  animate="show"
          className='w-full xl:w-3/5 h-full flex order-2 xl:order-1'>
          ...
          <motion.div className='w-full xl:w-2/5 gap-4 flex flex-col items-center justify-center xl:order-2 order-1'>
